...
export declare const filterData: <T extends Record<string, unknown>>(data: T[], filters: Record<string, unknown>) => T[];
...
export declare const getSelectedRowCount: (selectedRows: Record<string, boolean>) => number;
export declare const createSearchConfig: (query: string, caseSensitive?: boolean, searchFields?: string[]) => SearchConfig;
export declare const clearAllFiltersAndSearch: () => {
    filters: ColumnFilter[];
    searchConfig: SearchConfig;
};
export declare const createAvatarData: (label: string, options?: {
    sublabel?: string;
    imageUrl?: string;
    initials?: string;
}) => AvatarData;
export declare const createTagData: (text: string, options?: {
    color?: "primary" | "secondary" | "success" | "warning" | "error" | "neutral";
    variant?: "solid" | "subtle" | "outline";
    size?: "sm" | "md" | "lg";
}) => TagData;
export declare const createSelectData: (value: string, options?: {
    label?: string;
    disabled?: boolean;
}) => SelectData;
...
export declare const enforceDataTypeMatching: <T extends Record<string, unknown>>(data: T[], columns: ColumnDefinition<T>[], options?: {
