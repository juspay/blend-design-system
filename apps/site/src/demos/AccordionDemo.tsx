...
const AccordionDemo = () => {
    ...
    const [playgroundChevronPosition, setPlaygroundChevronPosition] =
        useState<AccordionChevronPosition>(AccordionChevronPosition.RIGHT)
                ...
                <div className="space-y-6">
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                        <SingleSelect
                            ...
                            onSelect={(value) =>
                                setPlaygroundType(value as AccordionType)
                            }
                        ...
                        <SingleSelect
                            ...
                            onSelect={(value) =>
                                setPlaygroundChevronPosition(
                                    value as AccordionChevronPosition
                                )
                            }
                            ...
                            >
                                ...
                                >
                                    ...
                                    >
                                        ...
                                        <p className="text-gray-600">
                                            Welcome to the platform! This guide
                                            will help you get started with the
                                            basic features.
                                        </p>
                                    </div>
                                </AccordionItem>
                                ...
                                >
                                    ...
                                    >
                                        ...
                                        <p className="text-gray-600">
                                            Discover advanced features that can
                                ...
                                >
                                    ...
                                    >
                                        ...
                                        <p className="text-gray-600">
                                            ...
                                            and learn how to resolve issues.
                                        </p>
                                    </div>
                                </AccordionItem>
                            </Accordion>
                            ...
                            <Accordion defaultValue="item1">
                                ...
                                >
                                    ...
                                    >
                                        ...
                                        <p className="text-gray-600">
                                            View your key metrics and important
                                ...
                                >
                                    ...
                                    >
                                        ...
                                        <p className="text-gray-600">
                                            Organize and manage your files and
                    ...
                    <Accordion isMultiple defaultValue={['item1', 'item3']}>
                        ...
                        >
                            ...
                            >
                                ...
                                <p className="text-gray-600">
                                    Configure your account preferences, security
                        ...
                        >
                            ...
                            >
                                ...
                                <p className="text-gray-600">
                                    Set up your notification preferences and
                        ...
                        >
                            ...
                            >
                                ...
                                <p className="text-gray-600">
                                    Control your data sharing preferences and
                                    privacy settings.
                                </p>
                            </div>
                        </AccordionItem>
                    ...
                    <Accordion defaultValue="item1">
                        ...
                        >
                            ...
                            >
                                ...
                                <p className="text-gray-600">
                                    This accordion item is enabled and can be
                        ...
                        >
                            ...
                            >
                                ...
                                <p className="text-gray-600">
                                    This content would be shown if the item was
                                    enabled.
                                </p>
                            </div>
                        </AccordionItem>
                        ...
                        >
                            ...
                            >
                                ...
                                <p className="text-gray-600">
                                    This accordion item is also enabled and
                                    functional.
                                </p>
                            </div>
                        </AccordionItem>
