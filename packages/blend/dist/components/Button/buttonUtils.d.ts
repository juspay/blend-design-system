...
export declare const getButtonSizeStyles: (
    size: ButtonSize,
    subType: ButtonSubType
) => import('styled-components').RuleSet<object>
export declare const getButtonTypeKey: (
    type: ButtonType
) => 'primary' | 'secondary' | 'danger' | 'success'
export declare const getButtonTypeStyles: (
    buttonType: ButtonType,
    subType: ButtonSubType
) => import('styled-components').RuleSet<object>
export declare const getLoadingStyles: (
    isLoading: boolean
) => import('styled-components').RuleSet<object>
