...
const meta: Meta<typeof StatCard> = {
    ...
    parameters: {
        ...
        docsSubtitle:
            'A versatile statistics card component for displaying key metrics, KPIs, and data visualizations.',
        docs: {
            description: {
                component: `
## Usage
...
export const DashboardExample: Story = {
    render: () => {
        ...
        return (
            <div className="grid grid-cols-[repeat(4,280px)] gap-4">
                {/* Row 1 - Key Metrics */}
                <StatCard
                    title="Total Revenue"
                    value="$845.2K"
...
export const BusinessMetricsShowcase: Story = {
    render: () => {
        ...
        return (
            <div className="grid grid-cols-[repeat(3,320px)] gap-5">
                {/* Financial Metrics */}
                <StatCard
