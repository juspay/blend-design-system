...
/**
 * V2 test page for Chrome autofill behavior
 * using TextInputV2 (floating labels, new tokens)
 */
const TextInputAutofillTestV2 = () => {
    ...
    const handleSubmit = (e: React.FormEvent) => {
        ...
        console.log('Form data (V2):', { password, username })
    }
        ...
        <div className="p-8 space-y-8">
            <div className="max-w-2xl mx-auto">
                <h1 className="text-3xl font-bold mb-4">
                    Autofill Detection Test (TextInputV2)
                </h1>
                <p className="text-gray-600 mb-8">
                    This page helps you test Chrome autofill detection with
                    floating labels using the new TextInputV2 component.
                </p>
                ...
                <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 mb-8">
                    ...
                    <ol className="list-decimal list-inside space-y-2 text-sm">
                        <li>
                            ...
                            and click &quot;Save Credentials&quot; to let Chrome
                            save them
                        </li>
                        <li>
                        ...
                        <li>
                            ...
                            and select a saved credential from Chrome&apos;s
                            dropdown
                        </li>
                    </ol>
                </div>
                ...
                <div className="mt-8 text-xs text-gray-500">
                    ...
                    <p className="mt-2">
                        🔧 <strong>Component:</strong> TextInputV2 with autofill
...
export default TextInputAutofillTestV2
