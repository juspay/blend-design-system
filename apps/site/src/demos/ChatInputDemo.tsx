                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                        ...
                        <div className="space-y-4">
                            ...
                            <p className="text-sm text-gray-600">
                                ...
                                files can fit based on the available width. A
                                "+X more" button appears that opens a menu with
                                the remaining files.
                            </p>
                        </div>
                    </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                        <div className="p-4 bg-blue-50 rounded-lg border border-blue-200">
                            ...
                            <p className="text-sm text-blue-700">
                                Attach multiple files with type-specific icons
                                and colors. Files display as removable tags.
                            </p>
                        </div>
                        ...
                        <div className="p-4 bg-purple-50 rounded-lg border border-purple-200">
                            ...
                            <p className="text-sm text-purple-700">
                                When files exceed the visible limit, show "+X
