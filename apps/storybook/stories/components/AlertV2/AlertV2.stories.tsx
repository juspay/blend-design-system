...
export const Default: Story = {
    args: {
        ...
        slot: { slot: <Info size={16} aria-hidden="true" /> },
        closeButton: {
            show: true,
            onClick: () => {},
        },
...
export const Types: Story = {
    render: () => (
        <div className="flex flex-col gap-4">
            <div>
                <h3 className="mb-2 text-sm text-gray-500">Subtle style</h3>
            ...
            <div>
                <h3 className="mb-2 text-sm text-gray-500">No fill style</h3>
                <div className="flex flex-col gap-2">
                    <AlertV2
                        type={AlertV2Type.PRIMARY}
    ...
    render: () => (
        <div className="flex flex-col gap-4">
            <AlertV2
                ...
                slot={{ slot: <CheckCircle2 size={16} aria-hidden="true" /> }}
                actions={{
                    primaryAction: {
                        text: 'View receipt',
                        onClick: () => {},
            ...
            <AlertV2
                ...
                slot={{ slot: <AlertTriangle size={16} aria-hidden="true" /> }}
                actions={{
                    primaryAction: {
                        text: 'Save changes',
                        onClick: () => {},
...
export const WithIconOnly: Story = {
    args: {
        ...
        slot: { slot: <User size={16} aria-hidden="true" /> },
        closeButton: {
            show: true,
            onClick: () => {},
        },
...
export const DismissibleOnly: Story = {
    args: {
        ...
        slot: { slot: <Bell size={16} aria-hidden="true" /> },
        closeButton: {
            show: true,
            onClick: () => {},
        },
...
export const Accessibility: Story = {
    render: () => (
        <div className="flex flex-col gap-6 max-w-[800px]">
            ...
            <div>
                <h3 className="mb-2 text-base font-bold">Decorative icons</h3>
                <p className="mb-3 text-sm text-gray-500">
                ...
                <AlertV2
                    ...
                    slot={{ slot: <XCircle size={16} aria-hidden="true" /> }}
                    closeButton={{
                        show: true,
                        onClick: () => {},
                    }}
