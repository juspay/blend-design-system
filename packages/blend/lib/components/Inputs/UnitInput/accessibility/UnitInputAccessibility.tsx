...
import { UnitInputSize, UnitPosition } from '../types'
import { unitInputAccessibilityReport } from './UnitInputAccessibilityReport'
import {
...
export type UnitInputAccessibilityProps = {
    className?: string
}

const UnitInputAccessibility = forwardRef<
    HTMLDivElement,
    UnitInputAccessibilityProps
>(({ className }, ref) => {
    ...
    const handleDownload = () => {
        try {
            ...
            const filename = `unitinput-accessibility-report-${unitInputAccessibilityReport.reportDate}.${getFileExtension(selectedFormat)}`
    ...
    const report = unitInputAccessibilityReport
            ...
            <div className="p-8 space-y-8 max-w-7xl mx-auto">
                    ...
                    <div className="flex items-start justify-between">
                        <div>
                            <h1 className="text-3xl font-bold mb-1 text-gray-900">
                                UnitInput Component Accessibility
                            </h1>
                ...
                <div className="bg-white border border-gray-200 rounded-lg p-6">
                    ...
                    <p className="text-sm text-gray-600 mb-6">
                        ...
                        announcements, numeric constraints, units, and error
                        states. All inputs have proper label associations, ARIA
                        attributes, and error handling.
                    </p>

                    <div className="space-y-6 max-w-2xl">
                        {/* Price with sublabel and hint */}
                        <UnitInput
                            label="Product Price"
                        ...
                        {/* Discount with range and error state */}
                        <UnitInput
                            label="Discount"
                            unit="%"
...
UnitInputAccessibility.displayName = 'UnitInputAccessibility'

export default UnitInputAccessibility
