...
import { buttonGroupAccessibilityReport } from './ButtonGroupAccessibilityReport'
import {
...
const ButtonGroupAccessibility = forwardRef<
    HTMLDivElement,
    ButtonGroupAccessibilityProps
>(({ className }, ref) => {
    ...
    const handleDownload = () => {
        try {
            const content = generateAccessibilityReport(
                buttonGroupAccessibilityReport,
                {
            ...
            const filename = `buttongroup-accessibility-report-${buttonGroupAccessibilityReport.reportDate}.${getFileExtension(selectedFormat)}`
    ...
    const report = buttonGroupAccessibilityReport
            ...
            <div className="p-8 space-y-8 max-w-7xl mx-auto">
                    ...
                    <div className="flex items-start justify-between">
                        <div>
                            <h1 className="text-3xl font-bold mb-1 text-gray-900">
                                ButtonGroup Component Accessibility
                            </h1>
                ...
                <div className="bg-white border border-gray-200 rounded-lg p-6">
                    ...
                    <p className="text-sm text-gray-600 mb-6">
                        ...
                        buttons in the group. All buttons maintain their
                        individual accessibility features. Focus order follows
                        the visual layout.
                    </p>
...
ButtonGroupAccessibility.displayName = 'ButtonGroupAccessibility'
