...
export const getSliderDarkTokens = (
    ...
    return {
        sm: {
            ...
            [SliderVariant.PRIMARY]: {
                trackBackground: foundationToken.colors.gray[800],
                rangeBackground: foundationToken.colors.primary[400],
                thumbBackground: foundationToken.colors.gray[50],
                thumbBorder: foundationToken.colors.primary[400],
                thumbFocusRing: foundationToken.colors.primary[400],
            },
            [SliderVariant.SECONDARY]: {
                trackBackground: foundationToken.colors.gray[800],
                rangeBackground: foundationToken.colors.gray[400],
                thumbBackground: foundationToken.colors.gray[50],
                thumbBorder: foundationToken.colors.gray[400],
                thumbFocusRing: foundationToken.colors.gray[400],
            },
