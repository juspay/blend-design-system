...
/>`,
    ...
    props: [
        ...
        trailingSlot?: React.ReactNode;
            ...
            propDescription:
                'Array of avatar data objects to display in the group',
        ...
        },
        {
            ...
            typeDefinition: 'string | number',
            propDescription:
                'Unique identifier for the avatar (AvatarData property)',
            llmContext:
                'Unique identifier for the avatar (AvatarData property)',
            propDefault: '-',
            category: 'Content',
        ...
        },
        {
            ...
            propDescription:
                'Image source URL for the avatar (AvatarData property)',
