...
import type { ColorGroupKey } from '@/components/studio/editor'
import {
    ArrowRight,
    ChartLineUp,
    Info,
...
interface ComponentShowcaseProps {
    theme?: 'light' | 'dark'
    className?: string
    activeColorGroup?: ColorGroupKey
}
...
const getTagColorForGroup = (group: ColorGroupKey | undefined): TagV2Color => {
    switch (group) {
        case 'gray':
            return TagV2Color.NEUTRAL
        case 'red':
            return TagV2Color.ERROR
        case 'green':
            return TagV2Color.SUCCESS
        case 'yellow':
        case 'orange':
            return TagV2Color.WARNING
        case 'purple':
            return TagV2Color.PURPLE
        case 'primary':
        default:
            return TagV2Color.PRIMARY
    }
}
...
>(
    (
        ...
        const activeTagColor = getTagColorForGroup(activeColorGroup)
            ...
            >
                <div className="mx-auto grid max-w-[1120px] grid-cols-1 gap-7 p-2 sm:grid-cols-2">
                    ...
                    <PreviewCard
                        ...
                        icon={
                            <ChartLineUp className="h-4 w-4 text-emerald-500" />
                        }
