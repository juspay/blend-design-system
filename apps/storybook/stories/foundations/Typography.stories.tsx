            ...
            <div>
                ...
                >
                    <div>
                        ...
                        >
                            Body Large - This is the default body text size used
                            for most content. It provides excellent readability
                    ...
                    <div>
                        ...
                        >
                            Body Medium - Used for secondary content, captions,
                            and UI elements. Slightly smaller but still highly
                            readable.
                        </div>
                    </div>
                    <div>
                        ...
                        >
                            Body Small - Used for fine print, metadata, and
                    ...
                    <div>
                        ...
                        >
                            Body Extra Small - Used for very compact spaces,
                            badges, and minimal UI elements.
                        </div>
                    </div>
                </div>
            </div>
                ...
                >
                    <div>
                        ...
                        >
                            ...
                            >
                                Normal text - The quick brown fox jumps over the
                                lazy dog
                            </div>
                            <div
                                style={{
                            ...
                            >
                                Italic text - The quick brown fox jumps over the
                                lazy dog
                            </div>
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        >
                            <div style={{ fontSize: '16px', fontWeight: 300 }}>
                                Light (300) - Perfect for large headings and
                                elegant displays
                            </div>
                            <div style={{ fontSize: '16px', fontWeight: 400 }}>
                                Regular (400) - Default weight for body text and
                                general content
                            </div>
                            <div style={{ fontSize: '16px', fontWeight: 500 }}>
                                Medium (500) - Ideal for subheadings and
                                emphasized content
                            </div>
                            <div style={{ fontSize: '16px', fontWeight: 600 }}>
                                Semi Bold (600) - Great for section headings and
                                important labels
                            </div>
                            <div style={{ fontSize: '16px', fontWeight: 700 }}>
                                Bold (700) - Strong emphasis and primary
                                headings
                            </div>
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        >
                            ...
                            >
                                This is a paragraph of body text demonstrating
                                the regular font weight. It shows how the
                                InterDisplay font renders in typical content
                                scenarios with proper line height and spacing.
                            </p>
                            <p
                                style={{
                                    fontSize: '14px',
                            ...
                            >
                                Caption or metadata text using medium weight for
                                subtle emphasis.
                            </p>
                        </div>
                    </div>
