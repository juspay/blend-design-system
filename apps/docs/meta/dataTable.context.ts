...
/>`,
  ...
  renderEditCell?: (value: T[keyof T], row: T, onChange: (value: unknown) => void) => React.ReactNode;
        ...
        },
        {
            ...
            typeDefinition: 'string',
            propDescription:
                'Optional table description displayed in the header',
...
enum FilterType {
  ...
  NUMBER = "number",
        ...
        },
        {
            ...
            typeDefinition: 'string',
            propDescription:
                'Optional additional class name for the table container',
            llmContext:
                'Optional additional class name for the table container',
            propDefault: '-',
        },
        ...
        },
        {
            ...
            typeDefinition: 'React.ReactNode',
            propDescription:
                'Custom bulk actions to display in the bulk action bar',
