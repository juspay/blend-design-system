...
import { textInputAccessibilityReport } from './TextInputAccessibilityReport'
import {
...
export type TextInputAccessibilityProps = {
    className?: string
}

const TextInputAccessibility = forwardRef<
    HTMLDivElement,
...
>(({ className }, ref) => {
    ...
    const handleDownload = () => {
        try {
            ...
            const filename = `textinput-accessibility-report-${textInputAccessibilityReport.reportDate}.${getFileExtension(selectedFormat)}`
    ...
    const report = textInputAccessibilityReport
            ...
            <div className="p-8 space-y-8 max-w-7xl mx-auto">
                    ...
                    <div className="flex items-start justify-between">
                        <div>
                            <h1 className="text-3xl font-bold mb-1 text-gray-900">
                                TextInput Component Accessibility
                            </h1>
                ...
                <div className="bg-white border border-gray-200 rounded-lg p-6">
                    ...
                    <p className="text-sm text-gray-600 mb-6">
                        ...
                        announcements, and error states. All inputs have proper
                        label associations, ARIA attributes, and error handling.
                    </p>
                    ...
                    <div className="space-y-6 max-w-2xl">
                        ...
                        <TextInput
                            ...
                            leftSlot={<Lock size={16} aria-hidden="true" />}
                            rightSlot={
                                <button
                                    type="button"
                                    onClick={() =>
...
TextInputAccessibility.displayName = 'TextInputAccessibility'

export default TextInputAccessibility
