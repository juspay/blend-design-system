...
const TextAreaV2Demo = () => {
    ...
    const [playgroundResize, setPlaygroundResize] = useState<
    ...
    return (
        <div className="p-8 space-y-12">
            ...
            <div className="space-y-6">
                <h2 className="text-2xl font-bold">Text Area V2 Playground</h2>
                <div className="space-y-6">
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                        ...
                        <SingleSelect
                            ...
                            onSelect={(value) =>
                                setPlaygroundRows(Number(value))
                            }
                        ...
                        <SingleSelect
                            ...
                            onSelect={(value) =>
                                setPlaygroundResize(
                                    value as typeof playgroundResize
                                )
                            }
                    ...
                    <div
                        className={`min-h-40 rounded-2xl w-full flex justify-center items-center border-2 border-dashed p-8 ${
                            theme === Theme.DARK
            ...
            <div className="space-y-6">
                <h2 className="text-2xl font-bold">
                    All Resize Options with States
                </h2>
