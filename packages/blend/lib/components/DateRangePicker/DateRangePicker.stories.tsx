...
- Custom (for manual selection)
    ...
    argTypes: {
        ...
        dateFormat: {
            description:
                'Format for date display (dd/MM/yyyy, yyyy-MM-dd, etc.)',
            control: 'text',
        },
    ...
    return (
        ...
        >
            ...
            >
                ...
                >
                    Select a date range to load analytics data. This example
                    shows how to integrate the DateRangePicker with data
            ...
            >
                ...
                <br />
                This shows how to integrate DateRangePicker with data fetching,
                loading states, and custom trigger styling for dashboard-like
                applications.
            </div>
        </div>
    )
