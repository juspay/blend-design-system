...
/>`,
    ...
    props: [
        ...
        },
        {
            ...
            typeDefinition: 'string',
            propDescription:
                'Additional label text displayed below the main label',
        ...
        },
        {
            ...
            typeDefinition: 'string',
            propDescription:
                'Error message displayed when input is in error state',
        ...
        },
        {
            ...
            propDescription:
                'Custom content displayed on the left side of the input',
            llmContext:
                'Custom content displayed on the left side of the input',
            propDefault: 'undefined',
            category: 'Content',
