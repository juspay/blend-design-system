...
import { useButtonTelemetry } from '../../telemetry/componentHooks'

const Button = forwardRef<HTMLButtonElement, ButtonV2Props>((props, ref) => {
    const {
    ...
    // Single line telemetry - automatically handles all props and derived analytics
    useButtonTelemetry(props)
    ...
    return (
        <PrimitiveButton
            ...
            height={subType === ButtonSubType.INLINE ? 'fit-content' : 'auto'}
