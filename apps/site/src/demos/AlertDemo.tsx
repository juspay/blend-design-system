...
const AlertDemo = () => {
    ...
    const [playgroundActionPlacement, setPlaygroundActionPlacement] =
        useState<AlertActionPlacement>(AlertActionPlacement.RIGHT)
                ...
                <div className="space-y-6">
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                        <TextInput
                            ...
                            onChange={(e) =>
                                setPlaygroundHeading(e.target.value)
                            }
                        ...
                        <TextInput
                            ...
                            onChange={(e) =>
                                setPlaygroundDescription(e.target.value)
                            }
                        ...
                        <SingleSelect
                            ...
                            onSelect={(value) =>
                                setPlaygroundVariant(value as AlertVariant)
                            }
                        ...
                        <SingleSelect
                            ...
                            onSelect={(value) =>
                                setPlaygroundStyle(value as AlertStyle)
                            }
                        ...
                        <SingleSelect
                            ...
                            onSelect={(value) =>
                                setPlaygroundActionPlacement(
                                    value as AlertActionPlacement
                                )
                            }
                ...
                <div className="space-y-4">
                    <Alert
                        ...
                        primaryAction={{
                            ...
                            onClick: () => {
                                console.log(
                                    'Primary action clicked from interactive example'
                                )
                        ...
                        secondaryAction={{
                            ...
                            onClick: () => {
                                console.log(
                                    'Secondary action clicked from interactive example'
                                )
