...
export const Visual_Showcase: Story = {
    ...
    render: () => (
        <div className="flex flex-col gap-6 p-6 max-w-200">
            ...
            <div className={`${sectionClasses} w-90`}>
...
function InteractiveRoutingDemo() {
    ...
    return (
        <div className={`${sectionClasses} max-w-160`}>
            <div className={labelClasses}>
...
function InteractiveComposableDemo() {
    ...
    return (
        <div className={`${sectionClasses} max-w-140`}>
            <div className={labelClasses}>
