...
>(({ tokens, buttonProps }, ref) => {
    return (
        <PrimitiveButton
            ...
            width={tokens.row.primaryAction.width}
            height={tokens.row.primaryAction.height}
            borderRadius={tokens.row.primaryAction.borderRadius}
            background={tokens.row.primaryAction.background}
            boxShadow={tokens.row.primaryAction.boxShadow}
            color={String(tokens.row.primaryAction.color)}
            flexShrink={0}
