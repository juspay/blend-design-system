...
export const Shapes: Story = {
    render: () => (
        <div className="flex flex-col gap-4">
            <div>
                <h3 className="mb-3 text-sm text-gray-600">Squarical Shape</h3>
            ...
            <div>
                <h3 className="mb-3 text-sm text-gray-600">Rounded Shape</h3>
                <div className="flex gap-2 flex-wrap">
                    <SplitTag
                        primaryTag={{ text: 'Shape', color: TagColor.NEUTRAL }}
                        secondaryTag={{
...
export const RealWorldExamples: Story = {
    render: () => (
        <div className="flex flex-col gap-6">
            ...
            <div>
                <h3 className="mb-3 text-base font-bold">Server Monitoring</h3>
                <div className="flex gap-2 flex-wrap">
                    <SplitTag
                        primaryTag={{
                            text: 'CPU',
            ...
            <div>
                <h3 className="mb-3 text-base font-bold">Project Management</h3>
                <div className="flex gap-2 flex-wrap">
                    <SplitTag
                        primaryTag={{
                            text: 'Sprint',
    ...
    render: () => (
        <div className="flex flex-col gap-8">
            ...
            <div className="grid grid-cols-[repeat(auto-fit,minmax(300px,1fr))] gap-6">
                ...
                {/* User Info */}
                <div className="p-5 border border-gray-200 rounded-lg bg-gray-50">
                    <h4 className="mb-3 text-sm font-bold">User Information</h4>
                    <div className="flex flex-col gap-2">
                        <SplitTag
                            primaryTag={{
                                text: 'Role',
