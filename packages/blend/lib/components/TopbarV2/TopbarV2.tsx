                        ...
                        <SingleSelect
                            ...
                            customTrigger={
                                <PrimitiveButton
                                    ...
                                    backgroundColor="transparent"
                                    cursor="pointer"
                                    gap={topBarToken.merchantSelectTrigger.gap}
                                    padding="0"
                                    maxWidth="240px"
                                    overflow="hidden"
                                    aria-label={`Select merchant: ${selectedMerchant?.label ?? 'Select Merchant'}`}
                                >
                                    <Block
                                        display="flex"
                                        alignItems="center"
                                    ...
                                    <ChevronDown
                                        size={
                                            topBarToken.merchantSelectTrigger
                                                .icon.size as unknown as number
                                        }
                                        color={
                                            topBarToken.merchantSelectTrigger
                                                .icon.color
