...
;<Menu
    trigger={<Button text="Open Menu" buttonType={ButtonType.SECONDARY} />}
    items={[{ items: menuItems }]}
/>
```
...
```tsx
<Menu
    trigger={<Button text="Search Menu" buttonType={ButtonType.SECONDARY} />}
    items={[{ items: menuItems }]}
    enableSearch={true}
...
;<Menu
    trigger={<Button text="Sub Menu" buttonType={ButtonType.SECONDARY} />}
    items={[{ items: menuItems }]}
/>
```
