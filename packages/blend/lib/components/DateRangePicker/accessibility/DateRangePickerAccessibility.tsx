...
import { dateRangePickerAccessibilityReport } from './DateRangePickerAccessibilityReport'
import {
...
const DateRangePickerAccessibility = forwardRef<
    HTMLDivElement,
    DateRangePickerAccessibilityProps
>(({ className }, ref) => {
    ...
    const handleDownload = () => {
        try {
            const content = generateAccessibilityReport(
                dateRangePickerAccessibilityReport,
                {
            ...
            const filename = `daterangepicker-accessibility-report-${dateRangePickerAccessibilityReport.reportDate}.${getFileExtension(selectedFormat)}`
    ...
    const report = dateRangePickerAccessibilityReport
            ...
            <div className="p-8 space-y-8 max-w-7xl mx-auto">
                    ...
                    <div className="flex items-start justify-between">
                        <div>
                            <h1 className="text-3xl font-bold mb-1 text-gray-900">
                                DateRangePicker Component Accessibility
                            </h1>
                ...
                <div className="bg-white border border-gray-200 rounded-lg p-6">
                    ...
                    <p className="text-sm text-gray-600 mb-6">
                        ...
                        DateRangePicker trigger. Press Enter or Space to open
                        the calendar. Use arrow keys to navigate dates. All
...
DateRangePickerAccessibility.displayName = 'DateRangePickerAccessibility'
