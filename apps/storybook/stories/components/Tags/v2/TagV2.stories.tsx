        ...
        <div className="flex flex-col gap-8 max-w-200">
            ...
            <div>
                ...
                <div className="flex flex-col gap-3">
                    <div className="flex gap-2 items-center">
                        <span className="text-xs text-gray-500 w-15">XS:</span>
                        <TagV2
                            text="Extra Small"
                            size={TagV2Size.XS}
                            onClick={() => {}}
                    ...
                    <div className="flex gap-2 items-center">
                        <span className="text-xs text-gray-500 w-15">SM:</span>
                        <TagV2
                            text="Small"
                            size={TagV2Size.SM}
                            onClick={() => {}}
                    ...
                    <div className="flex gap-2 items-center">
                        <span className="text-xs text-gray-500 w-15">MD:</span>
                        <TagV2
                            text="Medium"
                            size={TagV2Size.MD}
                            onClick={() => {}}
                    ...
                    <div className="flex gap-2 items-center">
                        <span className="text-xs text-gray-500 w-15">LG:</span>
                        <TagV2
                            text="Large"
                            size={TagV2Size.LG}
                            onClick={() => {}}
