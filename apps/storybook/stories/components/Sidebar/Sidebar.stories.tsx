...
export const EcommerceExample: Story = {
    render: () => {
                ...
                <div style={{ height: '100vh', display: 'flex' }}>
                    <Sidebar
                        tenants={[
                            {
                                label: 'Fashion Brand',
                                icon: <Shirt size={16} color="#ec4899" />,
                            },
                            {
                                label: 'Electronics',
        ...
        return <EcommerceExampleComponent />
    },
    parameters: {
        docs: {
            description: {
                    ...
                    <Sidebar
                        tenants={[
                            ...
                            },
                            {
                                ...
                                icon: <Cloud size={16} color="#8b5cf6" />,
                            },
                            {
                                label: 'Security Hub',
