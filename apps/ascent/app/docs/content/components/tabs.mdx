        ...
        [
            {
                content: 'Tabs.items',
                hintText:
                    'Array of tab item objects for programmatic rendering. When provided, the component renders tabs dynamically based on this array instead of using the declarative children API. Each item should have a value, label, and content. This approach is ideal for dynamic tab management, where tabs can be added, removed, or modified programmatically. Supports features like closable tabs, default tabs, disabled states, and skeleton loading per tab.',
            },
