    ...
    return (
        <div className="h-full w-full relative flex items-center justify-center">
            ...
            <div className="absolute overflow-hidden w-100 h-30 top-[calc(50%-96px-119.5px)]">
                <div
                    className="w-100 h-55 bg-background border border-border absolute bottom-0"
            ...
            {/* Center full ellipse */}
            <div
                className="w-100 h-48.25 bg-[#fafafa] dark:bg-[#080809] border border-border relative z-10"
                style={{ borderRadius: '50%' }}
            />
            ...
            <div className="absolute overflow-hidden w-100 h-30 top-[calc(50%+96.5px)]">
                <div
                    className="w-100 h-55 bg-background border border-border absolute top-0"
                    style={{ borderRadius: '50%' }}
                />
            </div>
        </div>
