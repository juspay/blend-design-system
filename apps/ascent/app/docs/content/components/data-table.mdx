        ...
        [
            {
                content: 'bulkActions',
                hintText:
                    'Optional array of BulkAction objects that define actions available when one or more rows are selected. Each action appears as a button in the bulk actions bar that appears above the table when rows are selected. Actions receive the array of selected row IDs when clicked.',
            },
            {
                content: 'BulkAction[]',
                hintText: 'Array of bulk action configuration objects',
            },
            { content: '' },
        ],
        [
