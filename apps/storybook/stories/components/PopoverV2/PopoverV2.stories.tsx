...
- PopoverV2 content is properly associated with trigger via Radix UI's built-in ARIA attributes
...
\`\`\`tsx
import { PopoverV2, PopoverV2Size, Button } from '@juspay/blend-design-system';
...
\`\`\`
    ...
    argTypes: {
        ...
        size: {
            control: { type: 'select' },
            options: Object.values(PopoverV2Size),
            description:
                'Size variant of the popover affecting typography and spacing',
            table: {
                type: { summary: 'PopoverV2Size' },
                defaultValue: { summary: 'PopoverV2Size.MD' },
                category: 'Appearance',
            },
        },
        side: {
        ...
        primaryAction: {
            ...
            table: {
                type: { summary: 'PopoverV2ActionType' },
                category: 'Actions',
            },
        },
        secondaryAction: {
...
export const Default: Story = {
    ...
    args: {
        trigger: <Button text="Open PopoverV2" />,
...
export const Sizes: Story = {
    ...
    parameters: {
        docs: {
            description: {
                story: 'PopoverV2 comes in two sizes: Small for compact interfaces and Medium for standard use cases.',
            },
        },
    },
}
...
export const Positioning: Story = {
    ...
    parameters: {
        docs: {
            description: {
                story: 'PopoverV2 can be positioned on any side of the trigger: top, right, bottom, or left.',
            },
        },
    },
}
...
export const WithActions: Story = {
    ...
    parameters: {
        docs: {
            description: {
                story: 'PopoverV2 with primary and secondary action buttons for confirmations and workflows.',
            },
        },
    },
}
...
// Filter popover
export const FilterPopoverV2: Story = {
    render: () => {
...
export const ModalMode: Story = {
    ...
    parameters: {
        docs: {
            description: {
                story: 'PopoverV2 in modal mode with backdrop overlay for important notifications.',
            },
        },
    },
}
...
export const Accessibility: Story = {
            ...
            return (
                ...
                >
                    ...
                    <div>
                        ...
                        >
                            PopoverV2 with proper ARIA attributes and
                        ...
                        <PopoverV2
                            trigger={
                                <Button
                                    buttonType={ButtonType.PRIMARY}
                                    text="Open Accessible PopoverV2"
                                />
                            }
                            heading="Accessible PopoverV2"
                    ...
                    <div>
                        ...
                        <PopoverV2
                            trigger={
                                <Button
                                    buttonType={ButtonType.PRIMARY}
                                    text="Open Keyboard PopoverV2"
                                />
                            }
                            heading="Keyboard Accessible PopoverV2"
                    ...
                    <div>
                        ...
                        <PopoverV2
                            trigger={
                                <Button
                                    buttonType={ButtonType.PRIMARY}
                                    text="Open Escape Test PopoverV2"
                                />
                            }
                    ...
                    <div>
                        ...
                        <PopoverV2
                            trigger={
                                <Button
                                    buttonType={ButtonType.PRIMARY}
                                    text="Open Modal PopoverV2"
                                />
                            }
                            heading="Modal Mode PopoverV2"
    ...
    parameters: {
        docs: {
            description: {
                story: `
Interactive examples demonstrating the PopoverV2 component's accessibility features including keyboard navigation, ARIA attributes, focus management, and screen reader support.
