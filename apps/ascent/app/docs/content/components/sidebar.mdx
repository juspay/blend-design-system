        ...
        [
            {
                ...
                hintText:
                    'Optional maximum number of items to display before showing an overflow menu. When the number of items exceeds this limit, additional items are placed in an overflow menu. Useful for managing visual clutter when there are many options. Defaults to 5 items.',
            },
            {
                content: 'number',
                hintText:
                    'Positive integer representing maximum visible items before overflow',
            },
            { content: '' },
        ],
        [
