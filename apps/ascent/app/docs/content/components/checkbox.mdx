        ...
        [
            {
                content: 'label',
                hintText:
                    'Optional label text displayed next to the checkbox. Used for accessibility and as fallback when children are not provided.',
            },
            {
                content: 'string',
                hintText: 'Text label for the checkbox',
            },
            { content: '' },
        ],
        [
            {
                content: 'name',
                hintText:
                    'Optional form field name for the checkbox. When used in forms, this name is submitted with the form data along with the checked state.',
            },
            {
                content: 'string',
                hintText: 'Form field name for form submission',
            },
            { content: '' },
        ],
        [
