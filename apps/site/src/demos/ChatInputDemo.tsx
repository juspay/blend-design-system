...
const ChatInputDemo = () => {
    ...
    const ChatScreen = () => {
        ...
        return (
            <div className=" flex h-full flex-col flex-1 pt-1 p-4 gap-3">
                    ...
                    <div className="space-y-6">
                        ...
                        <div className="space-y-6">
                            ...
                            <div className="flex items-center gap-6">
                                ...
                                />
                                <Switch
                                    label="Show Chat Screen"
                                    checked={showChatScreen}
                                    onChange={() =>
                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                            ...
                            <div className="space-y-4">
                                ...
                                <p className="text-sm text-gray-600">
                                    The component automatically calculates how
                                    many files can fit based on the available
                                    width. A "+X more" button appears that opens
                                    a menu with the remaining files.
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="space-y-6">
                        ...
                        <div className="space-y-6">
                            <div className="space-y-3">
                                ...
                                />
                                <p className="text-sm text-gray-600">
                                    Top queries appear below the input with a
                                    border separator. Click any query to select
                                    it.
                                </p>
                            </div>
                        </div>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                            <div className="p-4 bg-blue-50 rounded-lg border border-blue-200">
                                ...
                                <p className="text-sm text-blue-700">
                                    Attach multiple files with type-specific
                                    icons and colors. Files display as removable
                                    tags.
                                </p>
                            </div>
                            ...
                            <div className="p-4 bg-purple-50 rounded-lg border border-purple-200">
                                ...
                                <p className="text-sm text-purple-700">
                                    When files exceed the visible limit, show
                                    "+X more" button with dropdown menu.
                                </p>
                            </div>
                            ...
                            <div className="p-4 bg-indigo-50 rounded-lg border border-indigo-200">
                                ...
                                <p className="text-sm text-indigo-700">
                                    Custom icons, sizes, max length, disabled
                                    states, and overflow menu props.
                                </p>
                            </div>
                            ...
                            <div className="p-4 bg-pink-50 rounded-lg border border-pink-200">
                                ...
                                <p className="text-sm text-pink-700">
                                    ARIA labels, keyboard navigation, focus
