...
> ⚠️ **Deprecated:** `Button` is deprecated. Use [`ButtonV2`](/docs/components/button-v2)
> for new work. See the [Button to ButtonV2 migration guide](/docs/migration/button)
> for the complete prop and token mapping.
        ...
        [
            {
                content: 'onClick',
                hintText:
                    "Optional callback function invoked when the button is clicked. It may receive the native mouse event and should handle the button's primary action. The button will be disabled during loading state.",
            },
            {
                content:
                    '(event?: React.MouseEvent<HTMLButtonElement>) => void',
                hintText:
                    'Function called when the user clicks the button, with an optional native mouse event',
            },
            { content: '' },
        ],
        [
