...
import type { MultiSelectItemV2Props } from './types'
...
const MultiSelectItemV2 = forwardRef<HTMLDivElement, MultiSelectItemV2Props>(
    (
        {
            item,
            selectedValues,
        ...
        const itemContent = (
            ...
            >
                <Block
                    ...
                    data-element="select-item-v2-multi"
                    data-id={item.label || 'select-item-v2-multi'}
                    ref={ref}
                    role="option"
                    ...
                    maxWidth="100%"
                    minWidth={0}
                    color={itemTokens.option.color[state]}
                    backgroundColor={
                        isSelected
                    ...
                    {item.subLabel && (
                        ...
                        >
                            <PrimitiveText
                                ...
                                color={itemTokens.description.color[state]}
                                truncate={!item.disableTruncation}
                                style={{
                                    width: '100%',
                                    minWidth: 0,
...
MultiSelectItemV2.displayName = 'MultiSelectItemV2'
