    ...
    render: () => (
        ...
        >
            ...
            <div>
                ...
                <div style={{ display: 'flex', gap: '8px', flexWrap: 'wrap' }}>
                    <Tag text="React" color={TagColor.PRIMARY} />
                    <Tag text="TypeScript" color={TagColor.SUCCESS} />
                    <Tag text="JavaScript" color={TagColor.WARNING} />
            ...
            <div>
                ...
                <div style={{ display: 'flex', gap: '8px', flexWrap: 'wrap' }}>
                    ...
                    <Tag
                        text="Location"
                        color={TagColor.WARNING}
                        leftSlot={<MapPin size={12} aria-hidden="true" />}
                        rightSlot={<X size={12} aria-hidden="true" />}
            ...
            <div>
                ...
                >
                    All tag variants maintain accessibility standards across
...
This story demonstrates WCAG 2.1 Level A, AA, and AAA compliance features of the Tag component.
...
2. **Screen Reader Testing**:
   ...
   - Verify interactive tags announce their action
...
5. **Visual Testing**:
   ...
   - Verify all variants maintain accessibility standards
