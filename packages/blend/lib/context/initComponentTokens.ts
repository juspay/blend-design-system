...
import { getDropdownInputV2Tokens } from '../components/InputsV2/DropdownInputV2/DropdownInputV2.tokens'
...
const initTokens = (
    ...
    return {
        ...
        DROPDOWN_INPUT_V2:
            componentTokens.DROPDOWN_INPUT_V2 ??
            getDropdownInputV2Tokens(foundationTokens, theme),
    }
}
