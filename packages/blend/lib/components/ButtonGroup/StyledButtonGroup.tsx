...
export const StyledButtonWrapper = styled.div<{
    ...
    ${({ $position, $isStacked }) => {
        ...
        if ($position === 'first') {
            return css`
                & > button {
                    border-top-right-radius: ${buttonGroupTokens.stacked
                        .positions.first.borderTopRightRadius};
                    border-bottom-right-radius: ${buttonGroupTokens.stacked
                        .positions.first.borderBottomRightRadius};
            ...
            return css`
                & > button {
                    border-top-left-radius: ${buttonGroupTokens.stacked
                        .positions.last.borderTopLeftRadius};
                    border-bottom-left-radius: ${buttonGroupTokens.stacked
                        .positions.last.borderBottomLeftRadius};
                }
            `
        }
