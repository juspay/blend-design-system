...
export declare const useComponentToken: (component: keyof ComponentTokenType) => SearchInputTokensType | TagTokensType | TextAreaTokensType | TextInputTokensType | NumberInputTokensType | AlertTokenType | ResponsiveRadioTokens | OTPInputTokensType | UnitInputTokensType | MultiValueInputTokensType | ResponsiveSwitchTokens | ResponsiveCheckboxTokens | TabsTokensType | TooltipTokensType | DropdownInputTokensType | ResponsiveButtonTokens | ModalTokensType | BreadcrumbTokenType | PopoverTokenType | MenuTokensType | MultiSelectTokensType | TableTokenType | CalendarTokenType | AccordionTokenType | StatCardTokenType;
