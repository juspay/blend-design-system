 ...
 */
const buildTimePickerDarkTokens = (
    ...
    dropdown: {
        ...
        column: {
            ...
            separator: `${foundationToken.border.width[1]} solid ${foundationToken.colors.gray[700]}`,
            header: {
        ...
        option: {
            ...
            focusOutline: `${foundationToken.border.width[2]} solid ${foundationToken.colors.primary[400]}`,
        },
    },
    errorMessage: {
...
export const getTimePickerDarkTokens = (
    foundationToken: FoundationTokenType
): ResponsiveTimePickerTokens => ({
    sm: buildTimePickerDarkTokens(
        foundationToken,
        foundationToken.unit[44] as string
    ),
    lg: buildTimePickerDarkTokens(
        foundationToken,
