        ...
        <div style={{ padding: '100px' }}>
            ...
            >
                <div style={{ padding: '20px 0' }}>
                    ...
                    >
                        This is the main content area of the popover. You can
                        place any content here, including text, forms, lists, or
                        other components.
                    </p>
                </div>
            </Popover>
        ...
        <div style={{ display: 'flex', gap: '24px', padding: '100px' }}>
            ...
            >
                <div style={{ padding: '16px 0' }}>
                    ...
                    >
                        Small popover content with compact spacing and optimized
                        typography.
                    </p>
                </div>
            </Popover>
            ...
            >
                <div style={{ padding: '20px 0' }}>
                    ...
                    >
                        Medium popover content with comfortable spacing for more
                        detailed information and better readability. Perfect for
                        longer descriptions and content.
                    </p>
                </div>
            </Popover>
        </div>
            ...
            >
                <div style={{ padding: '16px 0' }}>
                    <p style={{ margin: '0 0 16px 0', color: '#64748b' }}>
                        When a popover is in modal mode, it prevents interaction
                        with the rest of the page until it's closed. This is
                        useful for important confirmations or forms that require
                    ...
                    >
                        ...
                        >
                            💡 Try clicking outside this popover - it won't
                            close because it's in modal mode.
                        </p>
                    </div>
                </div>
            </Popover>
