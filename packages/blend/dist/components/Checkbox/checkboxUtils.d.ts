 ...
 */
export declare const getCheckboxIconColor: (
 ...
 */
export declare const getCheckboxTextColor: (
    tokens: CheckboxTokensType,
    disabled: boolean,
    error: boolean
) => string
 ...
 */
export declare const getCheckboxSubtextColor: (
    tokens: CheckboxTokensType,
    disabled: boolean,
    error: boolean
) => string
 ...
 */
export declare const getCheckboxTextProps: (
    tokens: CheckboxTokensType,
    size: CheckboxSize,
    disabled: boolean,
    error: boolean
 ...
 */
export declare const getCheckboxSubtextProps: (
    tokens: CheckboxTokensType,
    size: CheckboxSize,
    disabled: boolean,
    error: boolean
 ...
 */
export declare const getAccessibilityAttributes: (
    uniqueId: string,
