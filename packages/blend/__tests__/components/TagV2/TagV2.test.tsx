...
describe('TagV2 Component', () => {
    describe('Rendering', () => {
        ...
        it('renders with left slot', () => {
            render(<TagV2 text="Tag" leftSlot={<MockIcon />} />)
        ...
        it('renders with right slot', () => {
            render(<TagV2 text="Tag" rightSlot={<MockIcon />} />)
            expect(screen.getByText('Tag')).toBeInTheDocument()
            expect(screen.getByTestId('mock-icon')).toBeInTheDocument()
            expect(
    ...
    describe('Skeleton State', () => {
        it('renders skeleton when showSkeleton is true', () => {
            render(<TagV2 text="Loading" showSkeleton={true} />)
        ...
        it('renders normal tag when showSkeleton is false', () => {
            render(<TagV2 text="Normal Tag" showSkeleton={false} />)
