...
describe('ProgressBarV2 Accessibility', () => {
    describe('WCAG 2.0, 2.1, 2.2 (axe-core)', () => {
        ...
        it('linear segmented passes axe', async () => {
            const { container } = render(
                <ProgressBarV2
                    value={40}
        ...
        it('circular solid passes axe', async () => {
            const { container } = render(
                <ProgressBarV2
                    value={75}
        ...
        it('circular segmented track passes axe', async () => {
            const { container } = render(
                <ProgressBarV2
                    value={40}
                    variant={ProgressBarV2Variant.CIRCULAR}
        ...
        it('with showLabel passes axe', async () => {
            const { container } = render(
                <ProgressBarV2
                    value={55}
                    showLabel
                    aria-label="Progress with visible label"
                />
            )
            const results = await axe(container, {
                rules: {
