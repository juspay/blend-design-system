        ...
        sm: {
            ...
            uploadContainer: {
                ...
                backgroundColor: {
                    ...
                    [UploadState.DRAG_LEAVE]: foundationTokens.colors.gray[0],
                    [UploadState.DRAG_OVER]:
                        foundationTokens.colors.primary[50],
                    [UploadState.DROP]: foundationTokens.colors.gray[0],
                    [UploadState.UPLOADING]: foundationTokens.colors.gray[0],
                    [UploadState.SUCCESS]: foundationTokens.colors.green[100],
