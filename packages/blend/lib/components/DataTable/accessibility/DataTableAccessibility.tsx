...
import { dataTableAccessibilityReport } from './DataTableAccessibilityReport'
import {
...
export type DataTableAccessibilityProps = {
    className?: string
}
...
const DataTableAccessibility = forwardRef<
    HTMLDivElement,
    DataTableAccessibilityProps
>(({ className }, ref) => {
    ...
    const handleDownload = () => {
        try {
            ...
            const filename = `datatable-accessibility-report-${dataTableAccessibilityReport.reportDate}.${getFileExtension(selectedFormat)}`
    ...
    const report = dataTableAccessibilityReport
            ...
            <div className="p-8 space-y-8 max-w-7xl mx-auto">
                    ...
                    <div className="flex items-start justify-between">
                        <div>
                            <h1 className="text-3xl font-bold mb-1 text-gray-900">
                                DataTable Component Accessibility
                            </h1>
                ...
                <div className="bg-white border border-gray-200 rounded-lg p-6">
                    ...
                    <p className="text-sm text-gray-600 mb-6">
                        Test keyboard navigation: Use Tab to navigate between
                        filter icons and interactive elements. Use Arrow keys
                        (Up/Down/Left/Right) to navigate between table cells.
                        Press Enter or Space to select rows. Use Home/End for
                        quick navigation. All table functionality is accessible
                        via keyboard.
                    </p>
                    ...
                    <div className="space-y-6">
                        <DataTable
                            data={demoData}
                            columns={
                                demoColumns as ColumnDefinition<
                                    Record<string, unknown>
                                >[]
                            }
                            idField="id"
                            title="Accessibility Demo Table"
...
DataTableAccessibility.displayName = 'DataTableAccessibility'

export default DataTableAccessibility
