...
\`\`\`
    ...
    argTypes: {
        ...
        enableAdvancedFilter: {
            description:
                'Enable advanced filtering with custom filter component',
            control: 'boolean',
        },
        enableInlineEdit: {
        ...
        serverSideFiltering: {
            description:
                'Handle filtering on server-side (disables local filtering)',
            control: 'boolean',
        },
...
export const WithRowExpansion: Story = {
    ...
    args: {
        ...
        title: 'Employee Directory',
        description:
            'Click the expand icon to view detailed employee information',
        isHoverable: true,
        enableSearch: true,
        enableFiltering: true,
        ...
        <div>
            ...
            >
                ...
                <p style={{ margin: 0, fontSize: '14px', color: '#6b7280' }}>
                    🚀 All operations (search, filtering, pagination) are
                    handled server-side. Check the console to see API calls
                    being made.
                    {isLoading && (
