        ...
        >
            {!unit && (
                <Block
                    ...
                    zIndex={1}
                    borderLeft={
                        disabled ? border.disabled : border[borderState]
                    }
                />
            )}
            {unit ? (
                <Block
                    ...
                    borderRadius={`0px ${inputContainerTokens.inputContainer.borderRadius[size]} ${inputContainerTokens.inputContainer.borderRadius[size]} 0px`}
                >
                    <Text
